...
[**ClassList**](annotated.md) **>** [**ValueMap**](classValueMap.md)
...
| Type | Name |
| ---: | :--- |
| property var | [**currentKeyValue**](classValueMap.md#property-currentkeyvalue)  <br> |
...
------------------------------
The documentation for this class was generated from the following file `src/qml/editorwidgets/ValueMap.qml`
