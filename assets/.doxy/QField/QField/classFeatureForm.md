...
| signal void | [**toolbarClicked**](classFeatureForm.md#signal-toolbarclicked)  <br> |
| signal void | [**toolbarSwiped**](classFeatureForm.md#signal-toolbarswiped) (var direction) <br> |
...
```C++
void FeatureForm::toolbarClicked;
```
...
### signal toolbarSwiped 

```C++
void FeatureForm::toolbarSwiped;
```
