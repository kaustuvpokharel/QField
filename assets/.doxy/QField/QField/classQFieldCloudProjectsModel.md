...
|  Q\_INVOKABLE void | [**refreshProjectFileOutdatedStatus**](#function-refreshprojectfileoutdatedstatus) (const QString & projectId) <br>_Refreshes the project file (.qgs, .qgz) outdated status._  |
...
_Refreshes the project file (.qgs, .qgz) outdated status._ 
```C++
